...
function init() {
    var e = {
            zoom: 15,
            center: new google.maps.LatLng(24.978267, 121.5430033),
            disableDefaultUI: !0,
            scrollwheel: !1,
            draggable: !1,
            styles: [{
    ...
    var l = new google.maps.LatLng(24.978267, 121.5430033);
...
google.maps.event.addDomListener(window, "load", init), google.maps.event.addDomListener(window, "resize", function () {
    map.setCenter(new google.maps.LatLng(24.978267, 121.5430033))
});